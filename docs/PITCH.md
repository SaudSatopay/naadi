...
2. **The hero moment** — open **Chandra Kirana Stores** (New-to-Credit, no financials, UPI-heavy): consent → rails light up → six dimensions animate in → **724 ± 25, Grade B**. *"No balance sheet. Real, defensible score."*
3. **Explainability** — reason codes: strong daily UPI pulse (+38), high payer diversity (+21), late GSTR-3B twice (−14). Click the what-if: **+22 pts path shown to the borrower.**
4. **Munshi** — the memo writes itself: recommend **approve ₹4.2L working-capital line, 24m**, GST-filing covenant, flow-routing covenant, two early-warning triggers — every number traceable to a feature. *"Officer reviews, clicks approve. Minutes, not weeks."*
